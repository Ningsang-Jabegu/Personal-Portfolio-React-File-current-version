...
import SERVICE_PART from "./SERVICE_PART";

export default function ABOUT_PART({ compIn = 'About' }) {
    const homeContent = (
        <p aria-label="Brief introduction and mission statement">
            I’m Ningsang Jabegu, a web developer, cultural advocate, and future public servant, on a mission to blend technology, culture, and service. My goal is to leave a lasting impact through my work in software development, Yakthung promotion, and eventually, public service {compIn === 'Home' && (
                <Link to="/about" className="read-more-link" aria-label="Read more about Ningsang Jabegu">...</Link>
            )}
        </p>
    );
